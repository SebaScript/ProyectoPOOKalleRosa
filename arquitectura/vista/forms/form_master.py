...
class MasterPanel:
    def __init__(self):
        self.ventana = tk.Tk()
        self.ventana.title('Ventana personalizada')
        ...
        botones = ["Botón 1", "Botón 2", "Botón 3", "Botón 4", "Botón 5", "Botón 6", "Botón 7", "Botón 8", "Botón 9"]
        ...
        for boton_texto, funcion in zip(botones, [funcion_boton_1, funcion_boton_2, funcion_boton_3, funcion_boton_4, funcion_boton_5, funcion_boton_6, funcion_boton_7, funcion_boton_8, funcion_boton_9]):
